...
* Identified sentiment trends and fluctuations over time
...
* Processed Twitter data using PySpark
...
👉 [View Notebook](./twitter_sentiment_time_series_analysis.ipynb)

**Full version with outputs:**
👉 [View on nbviewer](https://nbviewer.org/github/rosilenedasilva/twitter-sentiment-time-series-pyspark/blob/main/twitter_sentiment_time_series_analysis_with_outputs.ipynb)

## 📁 Repository Structure

```text
├── pyspark_mysql.ipynb
├── twitter_sentiment_time_series_analysis.ipynb
├── twitter_sentiment_time_series_analysis_with_outputs.ipynb
├── README.md
├── .gitignore
└── .gitattributes
```
...
* The full notebook is provided via nbviewer due to GitHub notebook rendering limitations
* The clean notebook is optimised for quick viewing directly on GitHub
